...
const Wrapper = styled(Space)`
  ...
  &[data-is-fullscreened='false'] {
    ...
    /*
  If we're in space, the background color "blends in", in
  a not-very-nice way. We'll add a border, which will be
  removed if we're rendering in Paper or an Aside
*/
