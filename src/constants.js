...
LIGHT_COLORS.mutedBackground = LIGHT_COLORS.gray[100];
...
DARK_COLORS.mutedBackground = DARK_COLORS.background;
...
export const BREAKPOINTS = {
  ...
  xsAndLarger: `(min-width: ${(BREAKPOINT_SIZES.xs + 1) / 16}rem)`,
  smAndLarger: `(min-width: ${(BREAKPOINT_SIZES.sm + 1) / 16}rem)`,
  mdAndLarger: `(min-width: ${(BREAKPOINT_SIZES.md + 1) / 16}rem)`,
  lgAndLarger: `(min-width: ${(BREAKPOINT_SIZES.lg + 1) / 16}rem)`,
  xlAndLarger: `(min-width: ${(BREAKPOINT_SIZES.xl + 1) / 16}rem)`,
  mobile: `(max-width: ${BREAKPOINT_SIZES.md / 16}rem)`,
  desktop: `(min-width: ${(BREAKPOINT_SIZES.md + 1) / 16}rem)`,
};
...
export const SUPERHEADER_HEIGHT = 3; // in rems
export const IS_SALE_RUNNING = false;
export const SALE_SUPERHEADER_STATUS_KEY =
  'show-spring-sale-superheader-2024';
